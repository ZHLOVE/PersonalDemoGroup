...
+ (UIImage *)makeImage:(CGSize)size{
    ...
    NSArray *colors = [NSArray arrayWithObjects:(id)[UIColor colorWithHexString:@"0edf6f"].CGColor, (id)[UIColor colorWithHexString:@"#02ca72"].CGColor, nil];
    CGGradientRef gradient = CGGradientCreateWithColors(colorSpace, (CFArrayRef)colors, locations);
    CGPoint startPoint = CGPointMake(0,0);
    CGPoint endPoint = CGPointMake(375*ratio, 0);

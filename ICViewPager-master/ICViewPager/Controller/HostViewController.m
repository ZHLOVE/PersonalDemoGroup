...
- (UIViewController *)viewPager:(ViewPagerController *)viewPager contentViewControllerForTabAtIndex:(NSUInteger)index {
    ...
    CGFloat r = (50.0 + arc4random() % 100)/255;
    CGFloat g = (100.0 + arc4random() % 100)/255;
    CGFloat b = (150.0 + arc4random() % 100)/255;
    cvc.view.backgroundColor = [UIColor colorWithRed:r green:g blue:b alpha:1.0];

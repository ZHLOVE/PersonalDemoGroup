...
//        [self.rightButton setImage:[UIImage imageNamed:@"microphone"] forState:UIControlStateNormal];
        ...
        self.inputTextView.placeholder = @"Feedback";
...
- (UISegmentedControl *)segmentedControl {
    if (_segmentedControl == nil) {
        _segmentedControl = [[UISegmentedControl alloc] initWithItems:@[@"QQ", @"Phone", @"Email", @"Other"]];
...
//    self.editorTitle.text = self.contactInfoKeys[index];
    switch (index) {
        case 0:
            ...
            self.inputTextView.placeholder = @"for QQ number";
            break;
        case 1:
            self.inputTextView.text = [self.contactInfo valueForKeyPath:@"contact.phone"];
            self.inputTextView.keyboardType = UIKeyboardTypeNumberPad;
            self.inputTextView.placeholder = @"for phone number";
            break;
        case 2:
            ...
            self.inputTextView.placeholder = @"for email address";
            break;
        case 3:
            ...
            self.inputTextView.placeholder = @"anything else?";
            break;
        default:
            break;
    }

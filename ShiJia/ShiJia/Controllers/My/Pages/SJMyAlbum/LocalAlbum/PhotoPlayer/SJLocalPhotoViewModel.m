                                       ...
                                       andFileType:type
                                             Block:^(id result, NSError *error, CGFloat percent) {
                                                 ...
                                                 if (result) {
                                                     ...
                                                     xmppModel.playerType = [asset valueForProperty:ALAssetPropertyType]==ALAssetTypeVideo?@"video":@"photo";
                                                     xmppModel.action = @"play";
                                                     xmppModel.url = [NSString stringWithFormat:@"%@",model.url];
                                                     
                                                     [weakSelf.screenManager remoteLoacalFileWith:xmppModel andType:[asset valueForProperty:ALAssetPropertyType]==ALAssetTypeVideo?1:2];

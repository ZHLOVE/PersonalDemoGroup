...
//
@interface FLAnimatedGif : NSObject
...
@interface FLAnimatedGif (Logging)
...
#define FLLog(logLevel, format, ...) [FLAnimatedGif logStringFromBlock:^NSString *{ return [NSString stringWithFormat:(format), ## __VA_ARGS__]; } withLevel:(logLevel)]

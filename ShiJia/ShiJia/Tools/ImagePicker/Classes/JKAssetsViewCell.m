...
- (UIButton *)checkButton{
    if (!_checkButton) {
        ...
        _checkButton.frame= _imageView.frame;
        [_checkButton setImageEdgeInsets:UIEdgeInsetsMake(_imageView.frame.size.height-20,_imageView.frame.size.width-20, 0, 0)];

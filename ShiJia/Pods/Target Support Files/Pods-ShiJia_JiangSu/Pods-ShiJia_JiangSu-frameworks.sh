...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "$BUILT_PRODUCTS_DIR/AFXMLDictionarySerializer/AFXMLDictionarySerializer.framework"
  ...
  install_framework "$BUILT_PRODUCTS_DIR/UPYUN/UPYUN.framework"

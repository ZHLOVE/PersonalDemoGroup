...
- (void)setEmployee:(EmployeeM *)employee{
    ...
    [_porImgView sd_setImageWithURL:[NSURL URLWithString:employee.avatar_url] placeholderImage:[UIImage imageNamed:@"default_touxiang"]];
}
...
//        [_porImgView setImage:[UIImage imageNamed:@"17"]];
    }
    return _porImgView;
}

...
//                       (id)[[UIColor colorWithRed:218.0/255.0 green:218.0/255.0 blue:218.0/255.0 alpha:1.0f] CGColor],
    ...
    UIView *shuXian = [[UIView alloc]initWithFrame:CGRectMake(dialogContainer.bounds.size.width/2, dialogContainer.bounds.size.height - buttonHeight - buttonSpacerHeight, 1, buttonHeight)];
    shuXian.backgroundColor = [UIColor colorWithRed:198.0/255.0 green:198.0/255.0 blue:198.0/255.0 alpha:1.0f];
    [dialogContainer addSubview:lineView];
    // 竖线
    [dialogContainer addSubview:shuXian];

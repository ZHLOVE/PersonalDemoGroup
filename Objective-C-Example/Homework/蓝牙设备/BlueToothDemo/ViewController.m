...
@property(nonatomic,strong)CBCharacteristic *writeCharacter;//用来监控蓝牙灯颜色的一个特征对象
@end
...
- (void)viewDidLoad {
    [super viewDidLoad];
   //初始化中心管理设备，外围设备，设备的服务信息// 关于中心 http://blog.csdn.net/dwarven/article/details/37873777
...
- (IBAction)scanCharBtnPressed:(id)sender {
...
- (IBAction)sendBtnPressed:(id)sender {
    NSTimer *timer = [NSTimer scheduledTimerWithTimeInterval:0.2
                                                      target:self
                                                    selector:@selector(changeLightColor:)
                                                    userInfo:nil
                                                     repeats:YES];
    //每1秒运行一次function方法。
}

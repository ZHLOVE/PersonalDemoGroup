...
- (void)drawRect:(CGRect)rect{
    ...
    scanRect = CGRectOffset(innerRect, 0, 15);
    _overlay.path = [UIBezierPath bezierPathWithRoundedRect:scanRect cornerRadius:0].CGPath;
    _lineLayer.path = [UIBezierPath bezierPathWithRoundedRect:CGRectMake(scanRect.origin.x+1, scanRect.origin.y, scanRect.size.width-2,1) cornerRadius:0].CGPath;
